...
class Students(models.Model):
    ...
    roll = models.PositiveSmallIntegerField(blank=False)
    ...
    birth_certificate = models.IntegerField(blank=False,unique=True)
    ...
    father_NID = models.IntegerField(blank=False)
    mother_NID = models.IntegerField(blank=False)
