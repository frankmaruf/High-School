...
class Students(models.Model):
    ...
    roll = models.PositiveIntegerField(blank=False)
    ...
    birth_certificate = models.PositiveIntegerField(blank=False,unique=True)
    ...
    father_NID = models.PositiveIntegerField(blank=False)
    mother_NID = models.PositiveIntegerField(blank=False)
    contract = models.IntegerField(blank=False)
